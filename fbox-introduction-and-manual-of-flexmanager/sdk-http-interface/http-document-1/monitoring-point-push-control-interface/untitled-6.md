# Open A Monitoring Point

* **Function Description**

  The purpose of this interface is to subscribe to a monitoring point under the box, the preconditions before the signalr real-time data push event is triggered
...
* **Request Address \(pick one of two\)**
   ...
   **URL:**`[apiBaseUrl]dmon/{uid}/start`

   New Version**：**

   **URL:**`[Host Server]/api/dmon/{uid}/start`
...
* **Address Parameter Description**
  ...
  | Uid | string | Monitoring point id |
